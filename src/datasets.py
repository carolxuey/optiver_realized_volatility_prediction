...
class Optiver2DRegularDataset(Dataset):
        ...
        self.transforms = {
            ...
            'normalize': {
                'book_means': np.array([
                    ...
                    1.0000068043192514, 1.0000055320253616, 5.129816581143487e-08, 9.831598141593519e-08, 0, 0
                ]),
                'book_stds': np.array([
                    ...
                    0.003689893218043926, 0.00370745215558702, 6.618708642293018e-07, 1.2508970015188411e-06, 1, 1
                ]),
    ...
    def __getitem__(self, idx):
        ...
        book_wap1_gradient = np.gradient(book_wap1)
        book_wap2_gradient = np.gradient(book_wap2)
        book_sequences = np.hstack([
            ...
            book_wap1_gradient.reshape(-1, 1),
            book_wap2_gradient.reshape(-1, 1)
        ])
