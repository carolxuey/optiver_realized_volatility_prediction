...
class CNN2DModel(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.conv_block1 = Conv2dBlock(in_channels=in_channels, out_channels=8, skip_connection=True)
        self.conv_block2 = Conv2dBlock(in_channels=8, out_channels=16, skip_connection=True)
        self.conv_block5 = Conv2dBlock(in_channels=16, out_channels=32, skip_connection=True)
        self.conv_block6 = Conv2dBlock(in_channels=32, out_channels=16, skip_connection=True)
        self.conv_block7 = Conv2dBlock(in_channels=16, out_channels=8, skip_connection=True)
        self.conv_block8 = Conv2dBlock(in_channels=8, out_channels=1, skip_connection=True)
